...
一个可直接上传小学、初中和高中数学题目照片的网页 Demo。它通过硅基流动的
...
- 支持补充参考答案和教师说明
- 支持选择小学一年级至高中三年级，并按学段调整知识范围和讲解方式
...
- 复杂几何、图表或多步应用题可使用 32B/Thinking、Qwen3.5 122B 或 GLM-4.5V。
- Qwen3.5 397B 是旗舰高能力选项；耗时、费用和账户额度要求也最高。
- 大模型返回 HTTP 402 表示余额或付费额度不足，不是连接或推理超时。
